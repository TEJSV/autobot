...
G2 = nx.read_edgelist('User_friendlist_Dataset.txt', create_using = nx.Graph(), nodetype = int)


def draw():
    nx.draw(G)
    plt.savefig("user_friends_graphs.pdf")
    plt.show()
...
def compute_avg_rank(G):
    ...
    l.append(avg)
    l.append(AVG)
    print("Recommend rank Method 1: ")
    print(l[0])
    print("Recommend rank Method 2: ")
    print(l[1])
    return l
